                  ...
                  return Center(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(margin: EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.02),
                          width: MediaQuery.of(context).size.width * 0.15,
                          height: MediaQuery.of(context).size.width * 0.055,
                          decoration: BoxDecoration(
                              color: MyColors.C_2E3353,
                              borderRadius: BorderRadius.circular(12)),
                          child: Center(child: Text(data[index].type![0],style: TextStyle(color: MyColors.white),)),
                        )
                      ],
                    ),
                  ));
